  ...
  return (
    <div className="min-h-screen text-slate-100">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-slate-950">
        ...
        <div className="ite ms-center pointer-events-none absolute inset-x-0 bottom-20">
          <div className="flex h-full items-center justify-center px-6">
            <div className="pointer-events-auto relative mx-auto max-w-4xl text-center">
              ...
              <Badge className="mb-6 border-blue-800/50 bg-blue-900/30 text-blue-300 shadow-lg shadow-blue-600/20 backdrop-blur-sm hover:bg-blue-800/30">
                <Bot className="mr-2 h-4 w-4" /> Beta: Powered by Granite AI
              </Badge>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="group relative gap-0 overflow-hidden border-slate-800/50 bg-slate-900/50 p-0 backdrop-blur-sm transition-all duration-300 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-600/20"
              >
                {/* Card Glow Effect */}
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 to-purple-950 py-24">
...
const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        "fixed inset-x-0 top-5 z-50 mx-auto rounded-xl transition-all md:w-full",
        isMenuOpen ? "w-full" : "w-fit",
      )}
    >
      <div className="mx-auto max-w-4xl rounded-xl border-b border-slate-800/30 bg-transparent px-6 backdrop-blur-sm lg:px-3">
          ...
          <div className="hidden items-center space-x-8 lg:flex">
            <div className="group relative">
              ...
              {activeDropdown === "features" && (
                <div
                  className="absolute top-full left-0 mt-2 w-80 rounded-xl border border-slate-800/50 bg-slate-900/55 p-6 shadow-2xl shadow-black/20 backdrop-blur-3xl"
                  onMouseEnter={() => setActiveDropdown("features")}
                  onMouseLeave={() => setActiveDropdown(null)}
                >
